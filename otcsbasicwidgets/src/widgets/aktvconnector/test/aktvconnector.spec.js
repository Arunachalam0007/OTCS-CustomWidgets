define(['csui/utils/contexts/page/page.context',
  'otcsb/widgets/aktvconnector/aktvconnector.view', './aktvconnector.mock.js'
], function (PageContext, AktvconnectorView, mock) {
  'use strict';

  describe('AktvconnectorView', function () {
    beforeEach(function () {
    ...
    describe('given a server connection with the person to greet', function () {
      ...
      it('marks the widget with the right CSS class', function () {
        expect(view.$el.hasClass('otcsb--aktvconnector')).toBeTruthy();
      });
