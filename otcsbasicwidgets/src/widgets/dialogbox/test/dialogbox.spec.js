define(['csui/utils/contexts/page/page.context',
  'otcsb/widgets/dialogbox/dialogbox.view', './dialogbox.mock.js'
], function (PageContext, DialogboxView, mock) {
  'use strict';

  describe('DialogboxView', function () {
    beforeEach(function () {
    ...
    describe('given a server connection with the person to greet', function () {
      ...
      it('marks the widget with the right CSS class', function () {
        expect(view.$el.hasClass('otcsb--dialogbox')).toBeTruthy();
      });
