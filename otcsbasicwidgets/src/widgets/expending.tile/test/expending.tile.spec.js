define(['csui/utils/contexts/page/page.context',
  'otcsb/widgets/expending.tile/expending.tile.view', './expending.tile.mock.js'
], function (PageContext, ExpendingTileView, mock) {
  'use strict';

  describe('ExpendingTileView', function () {
    beforeEach(function () {
    ...
    describe('given a server connection with the person to greet', function () {
      ...
      it('marks the widget with the right CSS class', function () {
        expect(view.$el.hasClass('otcsb--expending-tile')).toBeTruthy();
      });
