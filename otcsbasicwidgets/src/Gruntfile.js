...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    requirejsBundleIndex: {
      all: {
        src: [
          'bundles/otcsb-all.js'
        ],
        dest: 'bundles/otcsb-index',
        options: {
          prefix: 'otcsb'
        }
      }
    ...
    replace: {
      ...
      debug: {
        files: [
          {
            src: ['otcsb-extensions.json'],
            dest: '../out-debug/otcsb-extensions.json'
          }
        ]
      },
      release: {
        files: [
          {
            src: ['otcsb-extensions.json'],
            dest: '../out-release/otcsb-extensions.json'
          }
        ]
      }
    },
    ...
    copy: {
      module: {
        files: [
          {
            cwd: "../srcmodules/otcsbasicwidgets",
            src: "**",
            dest: "../out-module/otcsbasicwidgets",
            expand: true
          },
          {
            cwd: "../out-release",
            src: "**",
            dest: "../out-module/otcsbasicwidgets/support",
            expand: true
          }
        ]
      }
    ...
    languagepack: {
      all: {
        options: {
          ...
          bundleIndexes: {
            'bundles/otcsb-index': ['bundles/otcsb-all']
          },
